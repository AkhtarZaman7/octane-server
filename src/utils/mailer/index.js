    ...
    let info = await transporter.sendMail({
      ...
      <div
          ...
          <p  style="
              ...
              width: 100%;
            "
          >Invitation Code :${code}</p>
          <p style="
              
              text-align: left;
              align-self: center;
              width: 100%;">
            ${teamName}  is using Octane to connect your team and provide a one-stop platform for collaboration and communication. Enjoy the following and more!
          </p>
          <ul>
            <li>Check team announcements posted by your coach</li>
            <li>
              Keep up with your team’s upcoming games and practices 
            </li>
            <li>Indicate your availability through the team schedule feature</li>
            <li>
              Chat with your teammates and share memories in Octane’s very own Team Chat!
            </li>
          </ul>
        
          <p>
           Octane is a mobile + web app for teams to collaborate, communicate and stay organized for all games and practices! Use the mobile app to chat with your teammates, let your coach know if you are unable to make it to upcoming events and manage your health reports to stay safe and protected while having fun.
        ...
        <p style="
              ...
              align-self: center;
              width: 100%;
            "><strong>Download the app and join ${teamName} with your personal invitation code ${code}!</strong> </p>
        <div
            style="
              display: flex;
              flex-direction: row;
